// Renders the BatchManagement client interface for training execution workflows.
import {
  ArrowLeft,
  Archive,
  Bell,
  ...
  return (
    <div className="mx-auto w-full max-w-[1180px] px-4 py-5 sm:px-5 lg:px-6">
      ...
      <section className="mt-4 grid gap-4">
        ...
        {['admin', 'coordinator'].includes(activeRole) ? <AiDecisionPanel key={batch.batchId} batch={batch} /> : null}
        {activeRole !== 'trainer' ? (
